...
-(id)init{
    ...
    if (self=[super init]) {
        ...
        self.frame=CGRectMake(10, 20, 355, 355);
...
-(void)initializeIslamicCalendar{
    ...
    //123
    NSArray *arrr = @[ @"2017-06-17",
                       @"2017-06-09",
                       @"2017-06-02",
                       @"2017-06-27",
                       @"2017-06-26",
                       @"2017-06-12"];
    _eventDateArr= [[NSMutableArray alloc]init];
    NSDateFormatter *df = [[NSDateFormatter alloc]init];
    [df setDateFormat:@"yyyy-MM-dd"];
    [df setTimeZone:[NSTimeZone systemTimeZone]];
    for (int i = 0; i<arrr.count; i++)
    {
        [_eventDateArr addObject:[df dateFromString:arrr[i]]];
...
//    collectionVew.scrollEnabled = NO;
    ...
    UILabel * labl =[[UILabel alloc]initWithFrame:CGRectMake(0, 0, 355, 35)];
    labl.backgroundColor=[UIColor colorWithRed:199/255.0f green:170/255.0f blue:44/255.0f alpha:1.0f];
    [self addSubview:labl];
    
    UILabel * labl1 =[[UILabel alloc]initWithFrame:CGRectMake(0, 35, 355, 1)];
    labl1.backgroundColor=[UIColor colorWithRed:0/255.0f green:37/255.0f blue:99/255.0f alpha:1.0f];
    [self addSubview:labl1];
    ...
    dateTextColor=[UIColor colorWithRed:0/255.0f green:37/255.0f blue:99/255.0f alpha:1.0f];
    dateBGColor=[UIColor whiteColor];
    daysNameColor=[UIColor blackColor];
    selectedDateBGColor=[UIColor colorWithRed:199/255.0f green:170/255.0f blue:44/255.0f alpha:1.0f];
...
//    cell.lblTitle.layer.cornerRadius=cell.frame.size.width/2;
//    cell.lblTitle.clipsToBounds=YES;
...
//            }else{
           ...
           // }
            ...
            if ([_eventDateArr containsObject:date])
            {
                
                
//                [[titelLbl layer] setBorderWidth:1.0f];
//                [[titelLbl layer] setBorderColor:[UIColor redColor].CGColor];
//                titelLbl.layer.cornerRadius=10;
